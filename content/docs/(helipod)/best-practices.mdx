...
- Service reference variables like `${{BackendService.RAILWAY_PRIVATE_DOMAIN}}`
...
```
BACKEND_URL=${{BackendService.RAILWAY_PUBLIC_DOMAIN}}
...
- Learn more about [Variables](/helipod/variables)
- Explore [Project Canvas](/helipod/project-canvas)
- Check [Deployments](/helipod/deployments) best practices
