...
<Cards>
  <Card icon={<RocketIcon className="text-green-500" />} title="Build and Deploy Options" href="/docs/advanced-usage#build-and-deploy-options">
    Tune build commands, deploy behavior, health checks, and scheduling.
  </Card>
  <Card icon={<NetworkIcon className="text-blue-500" />} title="Networking" href="/docs/advanced-usage#networking">
    Use private networking and public domains to connect services safely.
  </Card>
  <Card icon={<PlugZapIcon className="text-orange-500" />} title="Integrations" href="/docs/advanced-usage#integrations">
    Extend Helipod with the CLI, public API, and webhooks.
  </Card>
  <Card icon={<WaypointsIcon className="text-purple-500" />} title="Environments" href="/docs/advanced-usage#environments">
    Split development, staging, and production without mixing workloads.
  </Card>
  <Card icon={<EyeIcon className="text-rose-500" />} title="Observability" href="/docs/advanced-usage#observability">
