...
| [**Pre-deploy command**](/build-deploy/deployments/pre-deploy-command) | Run setup tasks between build and release cutover. |
...
- Read [Pre-deploy command](/build-deploy/deployments/pre-deploy-command)
- Continue to [Services](/build-deploy/services)
- Return to [Build & Deploy](/build-deploy)
