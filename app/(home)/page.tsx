      ...
      <div className="relative flex min-h-[600px] h-[70vh] max-h-[900px] border rounded-2xl overflow-hidden mx-auto w-full max-w-[1400px] bg-origin-border">
        ...
        <div className="flex flex-col z-2 px-4 size-full md:p-12 max-md:items-center max-md:text-center">
          ...
          <div className="flex flex-row items-center justify-center gap-4 flex-wrap w-fit">
            <Link href="/" className={cn(buttonVariants(), 'max-sm:text-sm')}>
              Getting Started
            </Link>
            <a
    ...
    <div className="relative col-span-full min-h-[570px] px-2 py-6 rounded-2xl z-2 border shadow-md">
      ...
      <div className="w-full m-auto max-w-[500px] text-start shadow-xl p-2 bg-fd-card/80 backdrop-blur-md rounded-xl border shadow-black/50 dark:bg-fd-card/50">
        <div className="pt-3 px-3">
          ...
          <div className="mb-4 rounded-xl border bg-fd-secondary p-3 text-xs text-fd-secondary-foreground shadow-inner">
            <div className="flex items-center gap-2 border-b border-fd-border/60 pb-2">
              <div className="size-2 rounded-full bg-brand" />
              <span className="font-medium">Live component controls</span>
            </div>
            <div className="mt-3 grid gap-2 sm:grid-cols-2">
              <div className="rounded-lg border bg-fd-card p-3">
                <p className="font-medium">Variants</p>
                <p className="text-fd-muted-foreground">Show different states in docs.</p>
              </div>
              <div className="rounded-lg border bg-fd-card p-3">
                <p className="font-medium">Actions</p>
                <p className="text-fd-muted-foreground">Highlight interactions clearly.</p>
              </div>
            </div>
          </div>
          <Link
        ...
        <div className="mx-3 mb-3 overflow-hidden rounded-xl border bg-fd-card/90 p-3 shadow-lg">
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-3">
            <div className="rounded-lg border bg-fd-secondary p-3">
              <div className="mb-2 h-2 w-12 rounded-full bg-brand/70" />
              <div className="h-20 rounded-md border border-dashed border-fd-border/80 bg-fd-card" />
            </div>
            <div className="rounded-lg border bg-fd-secondary p-3">
              <div className="mb-2 h-2 w-10 rounded-full bg-brand/50" />
              <div className="h-20 rounded-md border border-dashed border-fd-border/80 bg-fd-card" />
            </div>
            <div className="rounded-lg border bg-fd-secondary p-3 max-sm:hidden">
              <div className="mb-2 h-2 w-14 rounded-full bg-brand/40" />
              <div className="h-20 rounded-md border border-dashed border-fd-border/80 bg-fd-card" />
            </div>
          </div>
        </div>
